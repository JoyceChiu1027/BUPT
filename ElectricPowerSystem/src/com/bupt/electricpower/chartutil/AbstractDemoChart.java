...
public abstract class AbstractDemoChart {
  ...
  protected void setRenderer(XYMultipleSeriesRenderer renderer, int[] colors, PointStyle[] styles) {
    ...
    for (int i = 0; i < length; i++) {
     ...
     // r.addFillOutsideLine(new XYSeriesRenderer.FillOutsideLine(org.achartengine.renderer.XYSeriesRenderer.FillOutsideLine.Type.BOUNDS_ALL));
  ...
  abstract GraphicalView getChartView(Context context);
}
